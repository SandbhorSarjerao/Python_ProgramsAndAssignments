...
# Logo
logo_path = "coursera_logo.png"  # Replace with your file path
...
pdf.cell(0, 10, "[Digitally Signed]", ln=True)
pdf.cell(0, 10, "[Official Stamp: PAID]", ln=True)

# Save PDF
pdf.output("Coursera_Receipt_Signed_Stamped.pdf")